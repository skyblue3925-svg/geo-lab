...
SIMULATION_SCENARIOS: dict[str, SimulationScenario] = {
    ...
    "cinder_cone": SimulationScenario("cinder cone", "volcanic", "process_proxy", PROXY_CAVEAT),
    ...
    "kettle_lake": SimulationScenario("kettle lake", "glacial", "process_proxy", PROXY_CAVEAT),
    ...
    "marine_terrace": SimulationScenario("marine terrace", "coastal_marine", "process_proxy", PROXY_CAVEAT),
    ...
    "outwash_plain": SimulationScenario("outwash plain", "glacial", "process_proxy", PROXY_CAVEAT),
    ...
    "thermokarst": SimulationScenario("thermokarst", "glacial", "process_proxy", PROXY_CAVEAT),
    "tidal_flat": SimulationScenario("tidal flat", "coastal_marine", "process_proxy", PROXY_CAVEAT),
